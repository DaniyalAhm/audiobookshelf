<template>
  <div class="w-full h-full pt-20 relative">
    ...
    <div class="absolute top-0 right-20 bg-bg text-black-500 border-b border-l border-r border-black-200 z-20 rounded-b-md px-2 h-9 hidden md:flex items-center text-center">
      <p class="font-mono">{{ page }} / {{ numPages }}</p>
    </div>
    <div class="absolute top-0 right-40 bg-bg text-black-500 border-b border-l border-r border-black-200 z-20 rounded-b-md px-2 h-9 hidden md:flex items-center text-center">
