<template>
  <div ref="wrapper" role="dialog" aria-modal="true" class="modal modal-bg w-full h-full fixed top-0 left-0 items-center justify-center opacity-0 hidden" :class="`z-${zIndex}`">
