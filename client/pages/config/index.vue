<template>
  <div>
    ...
    <div class="flex items-center py-4">
      <div class="grow" />
      <p class="pr-2 text-sm text-primary">
      ...
      <a href="https://github.com/advplyr/audiobookshelf" target="_blank" class="text-white hover:text-black-500 hover:scale-150 hover:rotate-6 transform duration-500">
      ...
      <p class="pl-4 pr-2 text-sm text-primary">
        {{ $strings.MessageJoinUsOn }}
        <a class="underline" href="https://discord.gg/HQgCbd6E75" target="_blank">discord</a>
      </p>
      <a href="https://discord.gg/HQgCbd6E75" target="_blank" class="text-white hover:text-black-500 hover:scale-150 hover:rotate-6 transform duration-500">
